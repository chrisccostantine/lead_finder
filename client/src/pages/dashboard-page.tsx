  ...
  return (
    <div className="space-y-8">
      <section className="overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-br from-zinc-900 via-zinc-900 to-violet-950/50 p-7 shadow-glow sm:p-10">
        <div className="max-w-2xl"><div className="mb-5 inline-flex items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/10 px-3 py-1 text-xs text-violet-300"><Sparkles className="h-3.5 w-3.5" />Foundation ready</div><h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">Your growth workspace starts here.</h2><p className="mt-4 max-w-xl leading-7 text-zinc-400">The secure application foundation is in place. Lead intelligence, audits, and outreach workflows will arrive in their dedicated phases.</p></div>
      </section>
